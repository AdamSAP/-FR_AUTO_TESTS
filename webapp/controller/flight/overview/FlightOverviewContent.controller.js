sap.ui.define([
	...
	return BaseController.extend("sap.ui.demo.nav.controller.flight.overview.FlightOverviewContent", {
		...
		onInit: function () {
			...
			oRouter.getRoute("flightOverview").attachMatched(this._onRouteMatched, this);
		...
		onItemPressed : function (oEvent) {
			...
			this.getRouter().navTo("BookFlight",{
